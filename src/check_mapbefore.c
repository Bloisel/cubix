...
/*   Updated: 2024/07/04 23:19:21 by bloisel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_map_is_before(t_data *dta)
{
	...
	while (dta->map[i] && i < 6)
	{
		if (dta->map[i][0] == 'N' && dta->map[i][1] == 'O'
				&& dta->map[i][2] == ' ')
			i++;
		if (dta->map[i][0] == 'S' && dta->map[i][1] == 'O' &&
				dta->map[i][2] == ' ')
			i++;
		if (dta->map[i][0] == 'W' && dta->map[i][1] == 'E' &&
				dta->map[i][2] == ' ')
			i++;
		if (dta->map[i][0] == 'E' && dta->map[i][1] == 'A' &&
				dta->map[i][2] == ' ')
			i++;
